...
public class MostTransformer implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {

    private ViewPager viewPager;
    private MostInterface cardAdapter;
    private float lastOffset;
    private boolean scalingEnabled;

    public MostTransformer(ViewPager viewPager, MostInterface adapter) {
